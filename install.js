    ...
    o.run = o.run.concat([
      // nvidia 50 series
      {
        ...
        "params": {
          "venv": "venv",
          "path": "app",
          "message": "uv pip install torch==2.7.0 torchvision==0.22.0 torchaudio==2.7.0 xformers --index-url https://download.pytorch.org/whl/nightly/cu128 --force-reinstall --no-deps"
        },
      }
    ])
  }
